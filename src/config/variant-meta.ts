...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: 'NextSignal — AI-Powered Scenario Intelligence',
    description: 'NextSignal analyzes global signals — markets, geopolitics, news, and economic data — to produce probabilistic scenarios about what could happen next. See the signals. Understand the scenarios.',
    keywords: 'AI scenario intelligence, probabilistic scenarios, geopolitical signals, market intelligence, scenario analysis, signal detection, risk scenarios, bull bear base case, global intelligence, market signals, economic signals, OSINT, geopolitical risk',
    url: 'https://nextsignal.app/dashboard',
    siteName: 'NextSignal',
    shortName: 'NextSignal',
    subject: 'AI-Powered Scenario Intelligence and Global Situation Awareness',
    classification: 'AI Scenario Intelligence, Market Intelligence, Geopolitical Risk Analysis',
    categories: ['news', 'finance', 'productivity'],
    features: [
      'AI-powered Bull/Base/Bear scenario generation',
      'Global signal detection and classification',
      'Market radar — stocks, ETFs, crypto, commodities, FX',
      'Geopolitical signal monitoring (ACLED, UCDP, CII)',
      'Economic signal tracking (FRED, IMF, World Bank)',
      'Impact chain visualization (event → affected assets)',
      'Probabilistic scenario evidence tracking',
      'AI explainability — traceable evidence chains',
      'Watchlist with signal and scenario change tracking',
      'Meaningful alerts on scenario probability changes',
      '500+ curated news sources across 190+ countries',
      'Real-time conflict, military, maritime, aviation tracking',
    ],
  },
  tech: {

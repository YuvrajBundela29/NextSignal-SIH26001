...
export const FULL_FEEDS: Record<string, Feed[]> = {
  politics: [
    { name: 'WION World', url: rss('https://www.wionews.com/feeds/rss/world.xml') },
    { name: 'NDTV World', url: rss('https://feeds.feedburner.com/ndtvnews-world-news') },
    ...
    { name: 'DD News', url: rss('https://ddnews.gov.in/en/feed/') },

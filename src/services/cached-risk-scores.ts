...
function emptyFallback(): CachedRiskScores {
  ...
  return {
    cii: [
      { code: 'UA', name: 'Ukraine', score: 84.5, level: 'critical', trend: 'rising', change24h: 1.2, components: { unrest: 70, conflict: 95, security: 90, information: 83 }, lastUpdated: nowIso },
      { code: 'IL', name: 'Israel', score: 79.2, level: 'high', trend: 'rising', change24h: 2.1, components: { unrest: 65, conflict: 88, security: 85, information: 78 }, lastUpdated: nowIso },
      { code: 'TW', name: 'Taiwan', score: 64.8, level: 'high', trend: 'stable', change24h: 0.4, components: { unrest: 25, conflict: 60, security: 85, information: 89 }, lastUpdated: nowIso },
      { code: 'SD', name: 'Sudan', score: 91.0, level: 'critical', trend: 'rising', change24h: 0.8, components: { unrest: 92, conflict: 94, security: 90, information: 88 }, lastUpdated: nowIso },
      { code: 'MM', name: 'Myanmar', score: 78.4, level: 'high', trend: 'rising', change24h: 1.5, components: { unrest: 80, conflict: 82, security: 78, information: 74 }, lastUpdated: nowIso },
      { code: 'IR', name: 'Iran', score: 72.1, level: 'high', trend: 'rising', change24h: 1.8, components: { unrest: 74, conflict: 70, security: 76, information: 68 }, lastUpdated: nowIso },
      { code: 'YE', name: 'Yemen', score: 86.3, level: 'critical', trend: 'stable', change24h: -0.2, components: { unrest: 85, conflict: 90, security: 88, information: 82 }, lastUpdated: nowIso },
      { code: 'SY', name: 'Syria', score: 81.6, level: 'high', trend: 'stable', change24h: 0.1, components: { unrest: 78, conflict: 85, security: 84, information: 80 }, lastUpdated: nowIso },
      { code: 'RU', name: 'Russia', score: 68.4, level: 'high', trend: 'rising', change24h: 0.9, components: { unrest: 55, conflict: 82, security: 74, information: 63 }, lastUpdated: nowIso },
      { code: 'US', name: 'United States', score: 28.5, level: 'low', trend: 'stable', change24h: 0.0, components: { unrest: 32, conflict: 10, security: 35, information: 37 }, lastUpdated: nowIso },
      { code: 'CN', name: 'China', score: 41.2, level: 'normal', trend: 'stable', change24h: 0.3, components: { unrest: 30, conflict: 35, security: 52, information: 48 }, lastUpdated: nowIso },
      { code: 'IN', name: 'India', score: 32.4, level: 'normal', trend: 'stable', change24h: 0.1, components: { unrest: 28, conflict: 25, security: 38, information: 36 }, lastUpdated: nowIso },
      { code: 'DE', name: 'Germany', score: 22.0, level: 'low', trend: 'stable', change24h: -0.4, components: { unrest: 24, conflict: 5, security: 28, information: 31 }, lastUpdated: nowIso },
    ],
    strategicRisk: {
      score: 68.4,
      level: 'high',
      ...
      lastUpdated: nowIso,
      contributors: [
        { country: 'Ukraine', code: 'UA', score: 84.5, level: 'critical' },
        { country: 'Israel', code: 'IL', score: 79.2, level: 'high' },
        { country: 'Taiwan', code: 'TW', score: 64.8, level: 'high' },
      ],
    },
    protestCount: 142,
    computedAt: nowIso,

...
export function calculateLandslideRisk(
  ...
  if (level === 'CRITICAL') {
    ...
    advisoryHi = 'आसन्न खतरा: गंभीर भूस्खलन की संभावना। खड़ी ढलानों पर स्थित बस्तियों को तुरंत खाली करने की सलाह। प्रमुख राजमार्गों पर भारी वाहनों का आवागमन रोकें। एनडीआरएफ/एसडीआरएफ को सक्रिय करें।';
  } else if (level === 'HIGH') {
    ...
    advisoryHi = 'उच्च चेतावनी: अत्यधिक मिट्टी की नमी और भारी बारिश दर्ज। पहाड़ी मार्गों पर गैर-जरूरी यात्रा से बचें। जिला आपातकालीन केंद्र सक्रिय। बचाव उपकरण तैयार रखें।';
    ...
    advisoryHi = 'सलाह: मध्यम जल संचय। जल निकासी पुलियों और सड़क तटबंधों पर दरारों या रिसाव की निगरानी करें।';
  } else {
    advisoryEn = 'NORMAL: Terrain conditions within safe parameters. Continuous baseline telemetry active.';
    advisoryHi = 'सामान्य: भू-भाग की स्थिति सुरक्षित सीमाओं के भीतर है। निरंतर बेसलाइन टेलीमेट्री सक्रिय है।';
  }

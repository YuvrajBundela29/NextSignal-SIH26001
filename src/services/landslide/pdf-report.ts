  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>15.0 mm/hr</td>
        <td>${weather.currentRainfallMm > 15 ? '⚠️ Elevated' : '✅ Normal'}</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>${seismic.recentQuakes72hCount > 0 ? '⚠️ Active Tectonic Stress' : '✅ Quiescent'}</td>
      </tr>
    </tbody>
  </table>

...
const LOGO_URL = '/nextsignal-logo.jpg';
...
export async function renderStoryToCanvas(data: StoryData): Promise<HTMLCanvasElement> {
  ...
  ctx.fillText('NEXTSIGNAL.AI', textX, y + 26);
  ...
  ctx.fillText('NEXTSIGNAL.AI', footerTextX, H - 55);
  ctx.letterSpacing = '0px';
  ctx.fillStyle = '#888';
  ctx.font = '400 20px Inter, system-ui, sans-serif';
  ctx.fillText('AI-Powered Scenario Intelligence Platform', footerTextX, H - 30);

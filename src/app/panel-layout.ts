...
export class PanelLayoutManager implements AppModule {
  ...
  async renderLayout(): Promise<void> {
    ...
    setTrustedHtml(this.ctx.container, trustedHtml(`
      ...
      <div class="header nextsignal-header" role="banner">
        <div class="header-left">
          <a href="#overview" class="ns-brand-link" aria-label="NextSignal Home">
            <div class="ns-brand-icon-box">
              <img src="/nextsignal-logo.jpg" alt="NextSignal" style="width:100%;height:100%;object-fit:cover;border-radius:5px;" />
            </div>
            <div class="ns-brand-text-group">
              <span class="ns-brand-title">NextSignal</span>
              <span class="ns-brand-pill">AI SCENARIOS</span>
            </div>
          </a>

          <div class="ns-header-nav" role="tablist">
            <button class="ns-header-nav-btn active" data-section="overview" role="tab" aria-selected="true" title="Dashboard Overview">
              <span class="ns-nav-icon">⬡</span> Overview
            </button>
            <button class="ns-header-nav-btn" data-section="markets" role="tab" aria-selected="false" title="Market Radar">
              <span class="ns-nav-icon">◈</span> Markets
            </button>
            <button class="ns-header-nav-btn" data-section="signals" role="tab" aria-selected="false" title="Signal Engine Feed">
              <span class="ns-nav-icon">◎</span> Signals
            </button>
            <button class="ns-header-nav-btn ns-scenario-highlight-btn" data-section="scenarios" role="tab" aria-selected="false" title="Scenario Engine (What Happens Next?)">
              <span class="ns-nav-icon">⋮</span> Scenarios
            </button>
            <button class="ns-header-nav-btn" data-section="watchlist" role="tab" aria-selected="false" title="Scenario Watchlist">
              <span class="ns-nav-icon">☰</span> Watchlist
            </button>
            <button class="ns-header-nav-btn" data-section="alerts" role="tab" aria-selected="false" title="Intelligence Alerts">
              <span class="ns-nav-icon">◉</span> Alerts
            </button>
            <button class="ns-header-nav-btn ns-oracle-nav-btn" data-section="oracle" role="tab" aria-selected="false" title="Quantum Oracle AI Predictor (Gemma 4 Uncensored)">
              <span class="ns-nav-icon ns-oracle-pulse">⚡</span> AI Predictor
            </button>
          </div>
        </div>

        <div class="header-right">
          <div class="status-indicator" title="Live Global Feed">
          ...
          <button class="search-btn ns-search-bar-btn" id="searchBtn">
      ...
      <nav class="mobile-menu" id="mobileMenu" aria-label="Menu">
        <div class="mobile-menu-header">
          <span class="mobile-menu-title">NEXTSIGNAL COMMAND</span>
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          <div class="ns-brand-icon-box" style="width:24px;height:24px;font-size:11px">NS</div>
          <div class="site-footer-brand-text">
            <span class="site-footer-name">NEXTSIGNAL</span>
            <span class="site-footer-sub">AI Scenario Intelligence &middot; Built on <a href="https://github.com/koala73/worldmonitor" target="_blank" rel="noopener" class="site-footer-credit">World Monitor (AGPL-3.0)</a></span>
          </div>
        </div>
        <nav aria-label="NextSignal references">
          ${referenceLinksHtml}
          <a href="/docs" target="_blank" rel="noopener">Architecture & Docs</a>
          <a href="https://github.com/koala73/worldmonitor" target="_blank" rel="noopener">Upstream Source</a>
          ${this.ctx.isDesktopApp ? '' : `<span id="footerDownloadMount"></span>`}
        </nav>
        <span class="site-footer-copy">&copy; ${new Date().getFullYear()} NextSignal &middot; All scenarios are probabilistic</span>
      </footer>

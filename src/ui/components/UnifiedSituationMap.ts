...
export class UnifiedSituationMap {
 ...
 <span>Surface: <strong id="badge-thermal-val" style="color: #f97316;">24.0C</strong></span>
 <span style="color: #334155;">|</span>
 ...
 STREGIC CORRIDOR INSPECTION TOUR ACTIVE
 </div>
 ...
 <div>
 <div style="color: #94a3b8;">GEODETIC DISTCE:</div>
 ...
 if (elevEl) elevEl.textContent = ` ${m.elevationDeltaM}m (${m.terrainGradientPct}%)`;

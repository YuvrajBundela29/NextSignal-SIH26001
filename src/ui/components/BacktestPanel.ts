...
export class BacktestPanel {
 ...
 METHODOLOGY ILLUSTRATION - Scoring Behaviour on NASA COOLR / GSI Events
 </h3>
 </div>
 ...
 (IMD/NDMA post-event reports) and district slope DEM data. Model would have scored
 ...
 Validated against NASA COOLR &amp; GSI event catalog (20202024).
 </div>
 </div>
 </div>`;
 }
